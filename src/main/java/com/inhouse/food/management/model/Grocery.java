...
public class Grocery {
     ...
     */
    public Grocery(String name, double quantity, String unit, double pricePerUnit, LocalDate expiryDate) {
    ...
    public String toString() {
        return String.format("%s: %.2f %s, NOK %.2f/unit, Expiry: %s",
                name, quantity, unit, pricePerUnit, expiryDate);
    }
}